...
export function getNavGroups(locale: Locale): NavGroups {
  return {
    tools: [],
    convert: [
      lp(locale, 'image-to-url', 'Image to URL', 'link'),
    ...
    formatConvert: [
      ...
      lp(locale, 'convert-to-jpg', 'Convert to JPG', 'compare'),
      lp(locale, 'jpeg-to-jpg', 'JPEG → JPG', 'compare'),
      lp(locale, 'jfif-to-jpg', 'JFIF → JPG', 'compare'),
      lp(locale, 'avif-to-jpg', 'AVIF → JPG', 'compare'),
      lp(locale, 'tiff-to-jpg', 'TIFF → JPG', 'compare'),
      lp(locale, 'jpg-to-jpeg', 'JPG → JPEG', 'compare'),
    ...
    useCases: [
      ...
      lp(locale, 'image-hosting-for-google-forms', 'For Google Forms', 'assignment'),
      ...
      en('/image-hosting-for-ghost', 'For Ghost', 'auto_stories'),
